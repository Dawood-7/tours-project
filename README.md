...
- understood better as to how to pass props down the component tree. from the parent to the child. This is helpful for passing data.
- learnt better about fetching data. Always create another function to fetch data and then wrap the function separately in a useEffect. 
